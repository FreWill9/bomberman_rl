...
def game_events_occurred2(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    """
...
def end_of_round2(self, last_game_state: dict, last_action: str, events: List[str]):
    """
    Called at the end of each game or when the agent died to hand out final rewards.
    This replaces game_events_occurred in this round.
